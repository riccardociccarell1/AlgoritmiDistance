...
/**
 * classe che, dato un file
 *confronta tutte le stringhe fra loro.
 * restituiscono 1 le stringhe che soddisfano il greedy lineare
 */
import static org.algoritmiDiConfronto.StringInputTrasformation.InputTrasformation.stringaToListaCaratteri;
public class GreedylineareConfrontoDafile {
