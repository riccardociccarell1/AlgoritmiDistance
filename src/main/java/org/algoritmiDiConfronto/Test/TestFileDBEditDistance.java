...
TestFileDBEditDistance {
    public static void main(String[] args) {
        ...
        // stampaAlgoritmo.eseguiAlgoritmoSuCoppie(DB2M8K, MALAT1, TipologiaCoppie.COPPIE_CARATTERI, TipologiaCoppie.COPPIE_CARATTERI, TipologiaAlgoritmi.EDITDISTANCE);
        ...
        // stampaAlgoritmo.eseguiAlgoritmoSuCoppie(DB4PLX, MALAT1, TipologiaCoppie.COPPIE_CARATTERI, TipologiaCoppie.COPPIE_CARATTERI, TipologiaAlgoritmi.EDITDISTANCE);
        ...
        // stampaAlgoritmo.eseguiAlgoritmoSuCoppie(hTER, MALAT1, TipologiaCoppie.COPPIE_CARATTERI, TipologiaCoppie.COPPIE_CARATTERI, TipologiaAlgoritmi.EDITDISTANCE);
        ...
        // stampaAlgoritmo.eseguiAlgoritmoSuCoppie(MALAT1, PAN1, TipologiaCoppie.COPPIE_CARATTERI, TipologiaCoppie.COPPIE_CARATTERI, TipologiaAlgoritmi.EDITDISTANCE);


        // stampaAlgoritmo.eseguiAlgoritmoSuCoppie(MALAT1, PAN2, TipologiaCoppie.COPPIE_CARATTERI, TipologiaCoppie.COPPIE_CARATTERI, TipologiaAlgoritmi.EDITDISTANCE);
